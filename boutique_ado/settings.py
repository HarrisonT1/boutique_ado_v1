...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bag.contexts.bag_contents',  # renders the context file in the bag app to the whole project
            ],
            'builtins': [
...
if 'USE_AWS' in os.environ:
    # Cache static files
    ASW_S3_OBJECT_PARAMETERS = {
        'Expires': 'Thu, 31 Dec 2099 20:00:00 GMT',
        'CacheControl': 'max-age=94608000',
    }

    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutiquo-ado' # change this to your AWS bucket name
